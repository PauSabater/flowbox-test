import { getModePersist, setModePersist } from '@store/persist'
import styles from './btnMode.module.scss'
import { useEffect, useState } from 'react'


/**
 * Renders a button to change from to dark or light mode
 *
 * @return {JSX.Element} - BtnMode component
 */
export function BtnMode(): JSX.Element {
